  ...
  return (
    <div className="pricing-ambient relative overflow-hidden rounded-lg border border-white/70 bg-white/42 p-3 shadow-[0_28px_90px_rgba(47,74,59,0.16)] backdrop-blur-xl">
      ...
      <div className="relative grid gap-3 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="rounded-lg border border-white/20 bg-[linear-gradient(135deg,rgba(23,61,43,0.94)_0%,rgba(36,77,52,0.86)_54%,rgba(91,138,98,0.74)_100%)] p-6 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.18)] backdrop-blur-xl sm:p-8 lg:p-10">
          ...
          <h2 className="mt-3 text-balance text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
            {pricing.monthlyPrice}
          </h2>
          <p className="mt-3 text-xl font-bold text-[var(--saffron-200)]">
            per month, {pricing.discountText}
          </p>
        ...
        <div className="rounded-lg border border-white/70 bg-white/72 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.76)] backdrop-blur-xl sm:p-8 lg:p-10">
          ...
          <h3 className="mt-3 text-3xl font-extrabold text-[var(--green-950)]">
            {pricing.monthlyPrice}
          </h3>
          <p className="mt-2 font-semibold text-[var(--green-700)]">{pricing.discountText}</p>
